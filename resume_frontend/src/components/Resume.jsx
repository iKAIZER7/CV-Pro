...
const Resume = () => {
  ...
  if (!data) {
    return (
      <div className="text-center mt-10 text-red-500">
        No resume data found. Please generate your resume first.
      </div>
    );
  }
  ...
  const handleDownloadImage = () => {
    const node = document.getElementById('resume-download');
    toPng(node, {
      cacheBust: true,
      ...
      .then((dataUrl) => {
        download(dataUrl, `${data.personalInformation.fullName}.png`);
      })
      .catch((err) => {
